...
@WebServlet(name = "ReviewUserLeaveAdminServlet", urlPatterns = { "/ReviewUpdatedLeavesDeleter_Admin_Servlet" })
public class ReviewUpdatedLeavesDeleterAdminServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (deleteResult.equals("Success")) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("reviewUpdatedLeavesAdmin.jsp");
