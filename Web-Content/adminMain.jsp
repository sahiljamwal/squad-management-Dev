                ...
                >
                  ...
                  <div class="modal1 mfp-hide" id="myModal1">
                    ...
                    >
                      ...
                      >
                        ...
                        <h3>
                          Update User's Leave<span class="subtitle"
                            >Existing Users Information can be updated
                            here.</span
                          >
                        </h3>
                      </div>
                      <div
                        ...
                        style="padding: 30px;"
                      >
                        <a href="updateUsers.jsp" class="button"
                          >Click To Update User's Leaves.</a
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  <a href="#myModal2" data-lightbox="inline"
                    ><button
                      class="button button-border button-rounded button-fill fill-from-bottom button-black"
                    >
                      <i class="far fa-eye"></i><span> View Leave Details</span>
                    </button></a
                  >
                  ...
                  <div class="modal1 mfp-hide" id="myModal2">
                    ...
                    >
                      ...
                      >
                        ...
                        <h3>
                          View User's Leaves<span class="subtitle"
                            >Existing Users Information can be viewed
                            here.</span
                          >
                        </h3>
                      </div>
                      <div
                        ...
                        style="padding: 30px;"
                      >
                        <a href="viewUser.jsp" class="button"
                          >Click To View user.</a
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="modal1 mfp-hide" id="myModal3">
                    ...
                    >
                      ...
                      >
                        ...
                        <h3>
                          Add New Users<span class="subtitle"
                            >New Users Information can be added here.</span
                          >
                        </h3>
                      </div>
                      <div
                        ...
                        style="padding: 30px;"
                      >
                        <a href="addNewEmployee.jsp" class="button"
                          >Click To Add New user</a
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="modal1 mfp-hide" id="myModal4">
                    ...
                    >
                      ...
                      >
                        ...
                        <h3>
                          Review Updated User's Leave<span class="subtitle"
                            >Existing User's Pending Leaves sent for Approval
                            can be deleted here.</span
                          >
                        </h3>
                      </div>
                      <div
                      ...
                      >
                        <a href="DeleteUser" class="button"
                          >Click To Review user Leaves sent for approval.</a
                        >
                      </div>
                    </div>
                  </div>
