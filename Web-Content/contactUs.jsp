		...
		<section>
			<div class="container clearfix" >
				...
				<form class="nobottommargin" id="template-contactform"
					name="template-contactform" action="Contact_Us" method="post">
					<div class="col_half">
					...
					<div class="col_full">
						<label for="template-contactform-subject">Subject
							<small>*</small>
						</label> <input type="text" id="template-contactform-subject"
							name="subject" value="" class="required sm-form-control" required />
					</div>
					...
					<div class="col_full">
						...
						<textarea class="required sm-form-control"
							id="contactform-message" name="message" rows="6" cols="30"
							required></textarea>
					</div>

					<span style="color: red;"><%=(request.getAttribute("successmessageContact") == null) ? "" : request.getAttribute("successmessageContact")%></span>

					<div class="col_full">
						<button class="button button-3d nomargin" type="submit"
							id="template-contactform" name="template-contactform-submit"
